    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="delete-modal-title">{{ Lang::get('content::messages.delete_article') }}</h4>
            </div>
            <div class="modal-body">
                <p>{{ Lang::get('content::messages.delete_confirm') }} {{ Lang::get('content::messages.change_warning') }}</p>
            </div>
            <div class="modal-footer">
                {{ csrf_field() }}
                <input type="hidden" class="category">
                <input type="hidden" class="article">
