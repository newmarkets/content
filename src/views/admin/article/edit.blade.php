                ...
                <div role="tabpanel" class="tab-pane" id="publishing">
                    ...
                    <div class="form-group">
                        <div class="{{ $col }}-offset-2 {{ $col }}-10">
                            <div class="checkbox">
                                <label class="control-label">
                                    <input id="menu_item" type="checkbox" @checked(old('menu_item', $article->menu_item))
                                    aria-describedby="menu_item-error">
                                    {{ Lang::get('content::messages.menu_item') }}
                                    <span id="menu_item-error" class="sr-only"></span>
                                </label>
                            </div>
                        </div>
                    </div>
